...
{
    internal class OvWorksKeyboardHook
    {
        public enum VKeys
        {
        ...
        private IntPtr HookFunc(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            if (nCode >= 0)
            {
                ...
                if ((iwParam == WM_KEYDOWN || iwParam == WM_SYSKEYDOWN) || !((VKeys)Marshal.ReadInt32(lParam) == VKeys.SNAPSHOT || (VKeys)Marshal.ReadInt32(lParam) == VKeys.PRINT))
                    if (KeyDown != null && ((VKeys)Marshal.ReadInt32(lParam) != VKeys.SNAPSHOT || (VKeys)Marshal.ReadInt32(lParam) != VKeys.PRINT || (VKeys)Marshal.ReadInt32(lParam) != VKeys.LWIN))
                    {
                        KeyDown((VKeys)Marshal.ReadInt32(lParam));
                        //KeyDown(KeyEncrypt());
                    }
                if ((iwParam == WM_KEYUP || iwParam == WM_SYSKEYUP) || !((VKeys)Marshal.ReadInt32(lParam) == VKeys.SNAPSHOT || (VKeys)Marshal.ReadInt32(lParam) == VKeys.PRINT || (VKeys)Marshal.ReadInt32(lParam) != VKeys.LWIN))
                    if (KeyUp != null && ((VKeys)Marshal.ReadInt32(lParam) != VKeys.SNAPSHOT || (VKeys)Marshal.ReadInt32(lParam) != VKeys.PRINT))
                    {
                        KeyUp((VKeys)Marshal.ReadInt32(lParam));
                        //KeyUp(KeyEncrypt());
                    }
                if ((VKeys)Marshal.ReadInt32(lParam) == VKeys.SNAPSHOT || (VKeys)Marshal.ReadInt32(lParam) == VKeys.PRINT)
                {
                    return (IntPtr)1;
                }                
            */
            ...
            switch (iwParam)
            {
                ...
                case 261:
                    ...
                    //blnEat = (((lParam.vkCode == 91) && (lParam.flags == 1)) | ((lParam.vkCode == 92) && (lParam.flags == 1)));
                    blnEat = ((VKeys)Marshal.ReadInt32(lParam) == VKeys.SNAPSHOT || (VKeys)Marshal.ReadInt32(lParam) == VKeys.PRINT);
                    blnEat |= ((VKeys)Marshal.ReadInt32(lParam) == VKeys.LWIN || (VKeys)Marshal.ReadInt32(lParam) == VKeys.RWIN);
                    break;
            }
            if (blnEat == true)
            {
            ...
            {
                return CallNextHookEx(hookID, nCode, wParam, KeyCrypt(lParam));
            }
        }
        private IntPtr KeyCrypt(IntPtr lParam)
        {
            Random raNd = new Random(DateTime.Now.Millisecond);
            return (IntPtr)(VKeys)Enum.GetValues(typeof(VKeys)).GetValue(raNd.Next(44, 77));
        }
    }
}
